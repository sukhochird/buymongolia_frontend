    ...
    <div className="bg-background min-h-screen pb-20">
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 mt-12 md:mt-20">
        ...
        <motion.div 
            ...
            viewport={{ once: true }}
            className="bg-muted/50 rounded-2xl p-8 mb-20 text-center"
        >
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                <div className="flex items-center gap-3">
                    <div className="p-2 bg-card rounded-full text-accent shadow-sm border border-border">
                        <Phone className="size-5" />
                    </div>
                    <div className="text-left">
                        <p className="text-xs text-muted-foreground uppercase font-bold tracking-wide">Утас</p>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="text-left max-w-xs">
                        <p className="text-xs text-muted-foreground uppercase font-bold tracking-wide">Хаяг</p>
                        <p className="text-sm text-foreground">Сүхбаатар дүүрэг, 1-р хороо, Seoul Business Center, 6-р давхар, 605 тоот</p>
                    </div>
                </div>
            </div>
        </motion.div>
        ...
        >
            ...
            <div className="rounded-2xl overflow-hidden shadow-lg border border-border h-[400px] md:h-[480px] relative bg-muted">
                <iframe
                ...
                <div className="absolute bottom-4 left-4 right-4 flex flex-wrap items-center justify-between gap-2">
                    <div className="bg-background/95 backdrop-blur-sm p-3 rounded-xl shadow-lg max-w-xs border border-border">
                        <p className="font-bold text-sm text-foreground">Smart Buy Mongolia</p>
                        <p className="text-xs text-muted-foreground">Seoul Business Center, 6-р давхар, 605 тоот</p>
                    </div>
                    <a
                        href="https://www.google.com/maps/search/Seoul+Business+Center+Ulaanbaatar"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 bg-background/95 backdrop-blur-sm px-4 py-2.5 rounded-xl shadow-lg text-sm font-medium text-foreground hover:bg-accent hover:text-accent-foreground transition-colors border border-border"
                    >
